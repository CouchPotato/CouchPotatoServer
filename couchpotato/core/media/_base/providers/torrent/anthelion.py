...
class Base(TorrentProvider):
    ...
    urls = {
        'test': 'https://anthelion.me/',
        'login': 'https://anthelion.me/login.php',
        'login_check': 'https://anthelion.me/inbox.php',
        'detail': 'https://anthelion.me/torrents.php?torrentid=%s',
        'search': 'https://anthelion.me/torrents.php?%s&filter_cat%%5B1%%5D=1&action=advanced&group_results=1&searchstr=%s',
        'download': 'https://anthelion.me/%s',
    }
    ...
    def _searchOnTitle(self, title, movie, quality, results):
        ...
        if data:
            ...
            try:
                ...
                entries = result_table.find_all('tr', attrs = {'class': 'group_torrent'})
                for result in entries:

                    tds = result.find_all('td')
                    link = tds[0].find('a', recursive=False)
                    url = result.find('a', attrs = {'class': 'tooltip'})
    ...
    def getSceneOnly(self):
        return 'censored=1' if self.conf('scene_only') else ''
    ...
    'groups': [
        {
            ...
            'name': 'Anthelion',
            'description': '<a href="http://anthelion.me/" target="_blank">Anthelion</a>',
            'wizard': True,
