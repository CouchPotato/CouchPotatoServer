...
class Base(TorrentProvider):
    ...
    urls = {
        'download': 'https://www.gimmepeers.com/%s',
        'detail': 'https://www.gimmepeers.com/%s',
        'search': 'https://www.gimmepeers.com/browse.php?search=%s&page=%s&cat=%s',
        'test': 'https://www.gimmepeers.com/',
        'login': 'https://www.gimmepeers.com/login.php',
        'login_check': 'https://www.gimmepeers.com'
    }
    ...
    'groups': [
        {
            ...
            'name': 'GimmePeer',
            'description': 'Welcome to the Dark Side. <a href="https://www.gimmepeers.com" target="_blank">GimmePeers.com</a>',
            'wizard': True,
            ...
            'options': [
                ...
                },
                {
                    ...
                    'type': 'string',
                    'default': '',
                    'description': 'The user name for your gimmepeers account',
                },
                {
                    'name': 'password',
                    'label': 'Password',
