...
class Base(TorrentProvider):
    ...
    urls = {
        'test': 'https://www.iptorrents.eu/',
        'base_url': 'https://www.iptorrents.eu',
        'login': 'https://www.iptorrents.eu/torrents/',
        'login_check': 'https://www.iptorrents.eu/inbox.php',
        'search': 'https://www.iptorrents.eu/torrents/?%s%%s&q=%s&qf=ti&p=%%d',
    }
    ...
    'groups': [
        {
            ...
            'name': 'IPTorrents',
            'description': '<a href="http://www.iptorrents.eu">IPTorrents</a>',
            'wizard': True,
