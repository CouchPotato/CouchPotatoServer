...
class QualityPlugin(Plugin):
    ...
    qualities = [
        {'identifier': 'bd50', 'allow_3d': True, 'hd': True, 'size': (23000, 60000), 'label': 'BR-Disk', 'alternative': ['bd25'], 'allow': ['1080p'], 'ext':[],
			'tags': ['bdmv', 'certificate', ('complete', 'bluray')], 'tags_3d': ['3d', '2d+3d', '3d+2d']},
