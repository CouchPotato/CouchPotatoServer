...
var CategoryListBase = new Class({
    ...
    createOrdering: function() {
        ...
        })), new Element(".ctrlHolder#category_ordering").adopt(new Element("label[text=First as default]"), check = new Element("input[type=checkbox]", {
    ...
    saveOrdering: function() {
        ...
        console.log(Api.request("category.save_order", {
            data: {
                ids: ids
            }
        }));
